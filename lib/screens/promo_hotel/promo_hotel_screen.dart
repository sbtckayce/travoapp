...
class PromoHotelScreen extends StatefulWidget {
  const PromoHotelScreen(
      {super.key,
  ...
  @override
  State<PromoHotelScreen> createState() => _PromoHotelScreenState();
}

class _PromoHotelScreenState extends State<PromoHotelScreen> {
  ...
  void initState() {
    super.initState();
    promoCubit = BlocProvider.of<PromoCubit>(context);
  }
