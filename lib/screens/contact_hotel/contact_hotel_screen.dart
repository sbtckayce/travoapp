...
class ContactHotelScreen extends StatefulWidget {
  const ContactHotelScreen(
      {super.key,
  ...
  @override
  State<ContactHotelScreen> createState() => _ContactHotelScreenState();
}

class _ContactHotelScreenState extends State<ContactHotelScreen> {
